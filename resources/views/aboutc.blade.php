...
<html lang="en">
  ...
  <head>
    ...
    <title>More About Caribbean</title>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="content">
            ...
            <h2>Selamat datang DI CARIBBEAN</h2>
            <p>Warna-warni yang hidup di Caribbean menggambar gambar keindahan dan keberagaman.</p>
    ...
    <div class="container">
      <div class="row">
        <div class="slider-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Kota Kota di <em>Caribbean</em></h2>
            </div>
            <div class="col-lg-12">
              <div class="owl-cites-town owl-carousel">
                <div class="item">
                  <div class="thumb">
                    <img src="assets2/images/cities-01.jpg" alt="">
                    <h4>Havana</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="assets2/images/cities-02.jpg" alt="">
                    <h4>Kingston</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="assets2/images/cities-03.jpg" alt="">
                    <h4>George Town</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="assets2/images/cities-04.jpg" alt="">
                    <h4>Santo Domingo</h4>
                  </div>
                </div>
                <div class="item">
            ...
            <div class="item">
              <div class="thumb">
                ...
                <div class="text">
                  ...
                  <h6>Rp 50.000 Disc 30%<br><span>/orang</span></h6>
                  <div class="line-dec"></div>
                  <ul>
                    <li>Deal Includes:</li>
