      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="content">
            ...
            <h2>Selamat datang DI France</h2>
            <p>Keindahan yang Menakjubkan: Prancis dikenal dengan keindahan yang menakjubkan. Dari Menara Eiffel yang megah di Paris hingga pemandangan alam yang memesona di Provence, Prancis menawarkan panorama yang tak terlupakan.</p>
    ...
    <div class="container">
      <div class="row">
        <div class="slider-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Kota Kota di <em>France</em></h2>
            </div>
            <div class="col-lg-12">
              <div class="owl-cites-town owl-carousel">
                <div class="item">
                  <div class="thumb">
                    <img src="assets2/images/1.jpg" alt="">
                    <h4>Paris</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="assets2/images/2.jpg" alt="">
                    <h4>Marseille</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="assets2/images/3.jpg" alt="">
                    <h4>Lyon</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="assets2/images/4.jpg" alt="">
                    <h4>Nice</h4>
                  </div>
                </div>
                <div class="item">
