            ...
            <div class="card overflow-scroll">
                <div class="card-body">
                    ...
                    <form class="form-inline">
                            ...
                            <a href="" onclick="this.href='/laporanfilter/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value  " target="_blank" class="btn btn-primary mb-2">
                        Filter Pdf
                    </a>
</form>
