...
<html lang="en">
  ...
  <head>
    ...
    <title>More About Switzerland</title>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="content">
            ...
            <h2>Selamat datang DI Switzerland</h2>
            <p>Indah: Switzerland terkenal dengan keindahan alamnya yang menakjubkan, seperti pegunungan Alpen yang menjulang tinggi, danau-danau yang jernih, serta desa-desa yang menawan.</p>
    ...
    <div class="container">
      <div class="row">
        <div class="slider-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Kota Kota di <em>Switzerland</em></h2>
            </div>
            <div class="col-lg-12">
              <div class="owl-cites-town owl-carousel">
                <div class="item">
                  <div class="thumb">
                    <img src="assets2/images/s1.jpg" alt="">
                    <h4>Zurich</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="assets2/images/s2.jpg" alt="">
                    <h4>Geneva</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="assets2/images/s3.jpg" alt="">
                    <h4>Bern</h4>
                  </div>
                </div>
                <div class="item">
                  <div class="thumb">
                    <img src="assets2/images/s4.jpg" alt="">
                    <h4>Basel</h4>
                  </div>
                </div>
                <div class="item">
          ...
          <div class="owl-weekly-offers owl-carousel">
            <div class="item">
              <div class="thumb">
                ...
                <div class="text">
                  <h4>Zurich<br><span><i class="fa fa-users"></i> 234 Check Ins</span></h4>
...
@endif
            ...
            <div class="item">
              <div class="thumb">
                ...
                <div class="text">
                  <h4>Geneva<br><span><i class="fa fa-users"></i> 234 Check Ins</span></h4>
                  <h6>Rp 50.000<br><span>/orang</span></h6>
                  <div class="line-dec"></div>
                  <ul>
                    <li>Deal Includes:</li>
...
@endif
            ...
            <div class="item">
              <div class="thumb">
                ...
                <div class="text">
                  <h4>Bern<br><span><i class="fa fa-users"></i> 234 Check Ins</span></h4>
                  <h6>Rp 50.000<br><span>/orang</span></h6>
                  <div class="line-dec"></div>
                  <ul>
                    <li>Deal Includes:</li>
...
@endif
            ...
            <div class="item">
              <div class="thumb">
                <img src="assets/images/offers-01.jpg" alt="">
                <div class="text">
                  <h4>Basel<br><span><i class="fa fa-users"></i> 234 Check Ins</span></h4>
                  <h6>Rp 50.000<br><span>/orang</span></h6>
                  <div class="line-dec"></div>
                  <ul>
                    <li>Deal Includes:</li>
...
@endif
            ...
            <div class="item">
              <div class="thumb">
                <img src="assets/images/offers-02.jpg" alt="">
                <div class="text">
                  <h4>Luserne<br><span><i class="fa fa-users"></i> 234 Check Ins</span></h4>
                  <h6>Rp 50.000<br><span>/orang</span></h6>
                  <div class="line-dec"></div>
                  <ul>
                    <li>Deal Includes:</li>
...
@endif
            ...
            <div class="item">
              <div class="thumb">
                <img src="assets/images/offers-03.jpg" alt="">
                <div class="text">
                  <h4>Lausanne<br><span><i class="fa fa-users"></i> 234 Check Ins</span></h4>
                  <h6>Rp 50.000<br><span>/orang</span></h6>
                  <div class="line-dec"></div>
                  <ul>
                    <li>Deal Includes:</li>
