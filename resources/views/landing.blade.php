          ...
          <div class="owl-carousel owl-banner">
            <div class="item item-1">
              <div class="header-text">
                <span class="category">Ruby Travel</span>
                <h2>Travel Anda Akan Semakin Seru! </h2>
                <p>Ruby Travel Memiliki Banyak Kelebihan Mau tau Apa Saja kelebihan jasa kami? segera gunakan jasa kami cobakan sendiri!</p>
                <!-- <div class="buttons">
            ...
            <div class="item item-2">
              <div class="header-text">
                ...
                <h2>Apa aja sih fasilitas kami?</h2>
                <p>transportasi, akomodasi, atraksi wisata, makanan dan minuman, serta jasa tour leader yang dijual ke wisatawan dalam satu harga</p>
                <!-- <div class="buttons">
                  <div class="main-button">
                    <a href="#">Request Demo</a>
                  </div>
            ...
            <div class="item item-3">
              <div class="header-text">
                <span class="category">Diskon</span>
                <h2>Kenapa Kami Harus Memilih Travel ini?</h2>
                <p>Karena di travel ini banyak hal yang menarik menunggu andaa!!, dengan adanya diskon bisa sampai dengan 60% lho!!</p>
                <!-- <div class="buttons">
                  <div class="main-button">
                    <a href="#">Request Demo</a>
                  </div>
